  ...
  (generate
    ...
    (fn [itf]
      ...
      (let [[sample-hi-bleep (itf.smp_add (Sample_File :name "hi-bleep" :filename (get-random-bleep "hi") :loop "sustain"))]
            ...
            [melody-fns-main (list-comp (make-melody-fn sample-hi-bleep 60 (get sequences x) (get notes-sets x) :pace 4 :volume 40) [x (range 3)])]
            [melody-fns-bass (list-comp (make-melody-fn sample-bass 60 (get [sequence-bass sequence-bass (get sequences 1)] x) (get notes-sets x) :pace 8 :volume 64) [x (range 3)])]
        ...
        (let [[sample-808-bassdrum (itf.smp_add (Sample_File :name "808-bassdrum" :filename (get-random-sample "808" "bass")))]
          ...
          (strategy.gen_add (Generator_Callback 1 (make-probability-table-fn sample-808-bassdrum :probability-table bd-prob :seed beat-seed :trippy false)))
